...
const faqs = [
  ...
  { q: 'Tengo muchos productos pero no los tengo registrados, ¿cómo empiezo?', a: 'No necesitas hacer un inventario físico completo para empezar a vender. Activa la opción "crear producto al vender" y da de alta tus productos conforme los vayas vendiendo. Cuando escaneas un código de barras que no existe en el catálogo, aparece un modal para crear el producto con su stock inicial y se agrega al carrito automáticamente. Así vas armando tu catálogo sobre la marcha.' },
  ...
  { q: '¿Cómo funcionan los precios?', a: 'Se paga por sucursal, desde $399/mes por una. Mientras más sucursales tienes, menor es el precio por sucursal. Todo incluido, sin módulos extra.' },
