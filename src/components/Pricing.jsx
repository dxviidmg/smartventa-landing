...
const plans = [
  {
    ...
    features: ['1 Sucursal incluida', 'Punto de venta completo', 'Inventario en tiempo real', 'Corte de caja con exportación a Excel', 'Clientes y descuentos', 'Soporte vía WhatsApp'],
    cta: 'Comenzar',
    popular: false,
  },
  {
    ...
    features: ['8 Sucursales (tiendas o almacenes)', 'Todo del Plan Emprendedor', 'Traspasos y distribuciones', 'Tableros de análisis y KPIs', 'Auditoría integrada', 'Roles y permisos (Dueño, Admin, Vendedor)', 'Notificaciones en tiempo real', 'Soporte prioritario'],
    cta: 'Comprar',
    popular: true,
  },
];
